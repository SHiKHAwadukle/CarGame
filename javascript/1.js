window.HUB_EVENTS = {
        ...
        shouldStopLoop: function (E) {
          ...
          var _ = this._getTime();
          if (0 === this.timeOfFirstCallToShouldStopLoop) return this.timeOfFirstCallToShouldStopLoop
          var o = _ - this.timeOfFirstCallToShouldStopLoop;
          if (o < this.START_MONITORING_AFTER) return !1;
          if (o > this.STOP_ALL_MONITORING_TIMEOUT) return this.programNoLongerBeingMonitored = !0, !
          try {
        ...
        _throwAnErrorToStopPen: function () {
          throw "We found an infinite loop in your Pen. We've stopped the Pen from running. More deta
        },
        ...
        _checkOnInfiniteLoop: function (E, _) {
          ...
          var o;
          if (_ - this._loopTimers[E] > this.MAX_TIME_IN_LOOP_WO_EXIT) throw "Infinite Loop found on 
        },
        _getTime: function () {
          return +new Date
        }
        ...
        return !0 === _ && console.warn("[CodePen]: An infinite loop (or a loop taking too long) was 
